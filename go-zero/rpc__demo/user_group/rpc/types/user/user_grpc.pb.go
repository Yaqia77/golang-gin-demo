...
func (c *userActionClient) UserCreate(ctx context.Context, in *UserCreateRequest, opts ...grpc.CallOption) (*UserCreateesponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserActionServer) UserCreate(context.Context, *UserCreateRequest) (*UserCreateesponse, error) {
